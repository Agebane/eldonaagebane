...
@section('pageTitle', isset($pageTitle) ?$pageTitle : 'Definição')
@section('content')
...
<div class="card">
     ...
     <li class="nav-item">
     <a href="#tabs-home-17" class="nav-link active" data-bs-toggle="tab">Definição Geral</a>
      </li>
                    <li class="nav-item">
                      <a href="#tabs-profile-17" class="nav-link" data-bs-toggle="tab">Logo & IconFavorito</a>
                    </li>
                    <li class="nav-item">
                      <a href="#tabs-activity-17" class="nav-link" data-bs-toggle="tab">Redes Socias</a>
                    </li>
                  </ul>
                  <div class="card-body">
       ...
       <img src="" alt="" class="img-thumbnail" id="logo-image-preview" data-ijabo-default-img="{{\App\Models\Setting::find(1)->blog_logo}}">
                          ...
                          <form action="{{route('author.change-blog-logo')}}" method="post" id="changeBlogLogoForm">
                            ...
                            <div class="mb-2">
                             ...
                             <button class="btn btn-primary">Mudar logo</button>
                          </form>
                          </div>
                          <div class="col-md-6">

                          <h3>Mudar icon do site</h3>
                           <div class="mb-2" style="max-width:100px">
                            ...
                            <form action="{{route('author.change-blog-favicon')}}" method="post" id="changeBlogFaviconForm">
                              ...
                              <button class="btn btn-primary">Mudar icon</button>
                            </form>
...
$('input[name="blog_logo"]').ijaboViewer({
   ...
   allowedExtensions:['jpg','jpeg','png'],
    ...
    onSucces:function(message,element){
      alert(message);
    } 
