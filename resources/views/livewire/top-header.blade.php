          ...
          <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown d-none d-md-flex me-3">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-card">
                <div class="card">
                  <div class="card-body">
                    Eng.Eliseu Agebane o sistema não contem parte de notificação assim que for necessaria colocaremos.
                  </div>
                </div>
              </div>
            </div>
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a href="{{ route('author.logout') }}" class="dropdown-item" onclick="event.preventDefault();document.getElementById('logout-form').submit();" >Terminar sessão</a>
          ...
          <div class="collapse navbar-collapse" id="navbar-menu">
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
              <ul class="navbar-nav">
                ...
                @if(auth()->user()->type==1)
                <li class="nav-item">
                  <a class="nav-link" href="{{route('author.categorias')}}" >
                ...
                <li class="nav-item">
                  <a class="nav-link" href="{{route('author.usuarios')}}" >
